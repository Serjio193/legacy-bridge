...
static const uint16_t kBleBootPulseOnMs = 1200;
...
static uint32_t t420dH1OnDelayMs = 5000;
static uint32_t t420dH2OnDelayMs = 5000;
...
static void loadConfig() {
  ...
  t420dH1OnDelayMs = (uint32_t)prefs.getULong("t4_h1on_ms", 5000);
  t420dH2OnDelayMs = (uint32_t)prefs.getULong("t4_h2on_ms", 5000);
