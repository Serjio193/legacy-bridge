...
![Общий вид системы: паяльная станция, вытяжка и подключённый ESP32](assets/photos/system-overview.jpg)
...
![Крупный план ESP32-C3 (модуль)](assets/photos/esp32-closeup.jpg)
![Подключение проводов и конденсаторов к ESP32](assets/photos/esp32-wires-capacitors.jpg)
![Подключение SENSE к плате T420D (точка 1)](assets/photos/t420d-sense-point-1.jpg)
![Подключение SENSE к плате T420D (точка 2)](assets/photos/t420d-sense-point-2.jpg)
![Точка подключения питания 5V на плате T420D](assets/photos/t420d-5v-point.jpg)
...
![Пример размещения модуля в корпусе T420D](assets/photos/t420d-case-placement.jpg)
